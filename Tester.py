...
class GUI:
    ...
    def create_main_menu(self):
        ...
        self.difficulty_button = Button(classic_button, text="Beginner", font=("Calibri", 16), bg="#10401d", fg="white", width=12, command=lambda: self.change_difficulty(self.difficulty_button.cget("text")))
        ...
        Button(self.main_menu, text="Settings:gear_icon", font=("Calibri", 12), bg="grey", fg="blue", height=2, width=20, command=lambda: self.settings.create_settings_window(self.main_menu, self.Minesweeper)).grid(
            row=0, column=0)
    ...
    def change_retry_difficulty(self, button):
        ...
        for difficulty in "Beginner","Intermediate","Expert":
            difficulties.add_command(label=difficulty, command=lambda: button.config(text=difficulty))
    ...
    def classic_game_over_window(self, outcome, final_time):
        ...
        difficulty_changer = Button(game_finished_options, text="Change Difficulty?", bg="green", fg="white", font=("Calibri", 16), width=15, command = lambda: self.change_retry_difficulty(difficulty_changer))
        #difficulty_changer.bind("<Button-1>", lambda event: self.change_retry_difficulty(difficulty_changer))
